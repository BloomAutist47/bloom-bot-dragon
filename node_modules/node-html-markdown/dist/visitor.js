...
class Visitor {
    ...
    optimizeTree(node) {
        ...
        (function visit(node) {
            ...
            if (nodes_1.isTextNode(node) || (nodes_1.isElementNode(node) && config_1.contentlessElements.includes(node.tagName))) {
                ...
                const childNodes = utilities_1.getChildNodes(node);
    ...
    visitNode(node, textOnly, metadata) {
        ...
        if ((cfg.noEscape && !(metadata === null || metadata === void 0 ? void 0 : metadata.noEscape)) || (cfg.childTranslators && !(metadata === null || metadata === void 0 ? void 0 : metadata.translators))) {
            metadata = Object.assign(Object.assign({}, metadata), { noEscape: cfg.noEscape, translators: cfg.childTranslators });
            this.nodeMetadata.set(node, metadata);
        }
