...
exports.nodeHtmlParserConfig = exports.aTagTranslatorConfig = exports.defaultCodeBlockTranslators = exports.defaultTranslators = exports.defaultOptions = exports.contentlessElements = exports.defaultIgnoreElements = exports.defaultBlockElements = void 0;
...
exports.defaultTranslators = {
    ...
    'strong,b': {
        ...
        postprocess: ({ content, options: { strongDelimiter } }) => utilities_1.isWhiteSpaceOnly(content)
            ...
            : utilities_1.tagSurround(content, strongDelimiter)
    },
    /* Strikethrough */
    'del,s,strike': {
        spaceIfRepeatingChar: true,
        postprocess: ({ content }) => utilities_1.isWhiteSpaceOnly(content)
            ? translator_1.PostProcessResult.RemoveNode
            : utilities_1.tagSurround(content, '~~')
    },
    /* Italic / Emphasis */
    'em,i': {
        spaceIfRepeatingChar: true,
        postprocess: ({ content, options: { emDelimiter } }) => utilities_1.isWhiteSpaceOnly(content)
            ? translator_1.PostProcessResult.RemoveNode
            : utilities_1.tagSurround(content, emDelimiter)
    },
        ...
        if (!isCodeBlock)
            return {
                ...
                postprocess: ({ content }) => {
                    ...
                    return utilities_1.surround(utilities_1.surround(content, padding), delimiter);
                }
            };
        /* Handle code block */
