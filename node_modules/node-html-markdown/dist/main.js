...
class NodeHtmlMarkdown {
    ...
    translateWorker(htmlOrFiles) {
        ...
        for (const [fileName, html] of Object.entries(inputFiles)) {
            const parsedHtml = utilities_1.parseHTML(html, this.options);
            outputFiles[fileName] = visitor_1.getMarkdownForHtmlNodes(this, parsedHtml, fileName !== 'default' ? fileName : void 0);
        }
